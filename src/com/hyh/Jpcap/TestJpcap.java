...
public class TestJpcap {
    ...
    public static void getDevices() {
        ...
        for (int i = 0; i < devices.length; i++) {
            ...
            System.out.println(devices[i].mac_address);
...
//            System.out.println(" address:" + devices[i].addresses[devices[i].addresses.length-1].address+" " +devices[i].addresses[devices[i].addresses.length-1].subnet + " " + devices[i].addresses[devices[i].addresses.length-1].broadcast );
        }
    }
